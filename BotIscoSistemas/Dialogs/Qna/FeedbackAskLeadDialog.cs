...
{
    [Serializable]
    public class FeedbackAskLeadDialog : IDialog<IMessageActivity>
    {
        ...
        {
            var feedback = ((Activity)context.Activity).CreateReply("Quer me deixar algum contato para eu lhe enviar ***mais informação*** ?, Se quiser pode **comprar** direto comigo também .... ");
        ...
        public async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> result)
        {
            ...
            if (userFeedback.Text.Contains("yes-positive-feedback") || userFeedback.Text.Contains("no-negative-feedback"))
            {
                ...
                {
                    await context.Forward(new RegisterLeadDialog(), ResumeAfterQnA, context.Activity, CancellationToken.None);
                }
